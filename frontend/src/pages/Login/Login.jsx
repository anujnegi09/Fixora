...
//       <div className="absolute inset-30 bg-white w-full max-w-4xl  rounded-[2rem] shadow-xl overflow-hidden flex flex-col md:flex-row-reverse">
//         {/* Form side */}
...
const Login = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url(${authBg})` }}
    >
      <div className=" w-full max-w-2xl bg-white rounded-[2rem] translate-x-35 shadow-xl overflow-hidden">
        {/* Form side */}
